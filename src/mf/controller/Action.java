...
public abstract class Action {
	...
	/**
	 * A method which will send a debugging message to the user indicating that this
	 * subclass of action does not handle GET requests.
	 * 
	...
	public String performGet(HttpServletRequest request) {
		// Normally, we would return null to get a 404 error, but for easier
		// debugging...
		request.setAttribute("message", "No implementation of performGet() for action " + getName());
		return "error.jsp";
	}

	/**
	 * A method which will send a debugging message to the user indicating that this
	 * subclass of action does not handle POST requests.
	 * 
	...
	public String performPost(HttpServletRequest request) {
		// Normally, we would return null to get a 404 error, but for easier
		// debugging...
		request.setAttribute("message", "No implementation of performPost() for action " + getName());
	 ...
	 * 
	 * @param a
	 *            the action to be added to the map.
	 */
