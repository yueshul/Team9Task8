            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel"  style="padding:30px">
                      <h4 class="mb">Buy Fund</h4>
                      <form action="buyFund.do" method="post" class="form-horizontal style-form">
					...
					<c:forEach var="field" items="${form.visibleFields}"> 
                         ...
                         <center> <button type="submit" class="btn btn-info" name="action" value="buy">Buy Fund</button></center>
                      </form> 
                      						<!-- start of fund lists -->
